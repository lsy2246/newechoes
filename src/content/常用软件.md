...
[agent-browser](https://github.com/vercel-labs/agent-browser)：专为 AI 智能体设计的无头浏览器自动化工具
...
- **AI API 调用：** [chatbox](https://chatboxai.app/zh)
...
- **科学上网:** Shadowrocket（需要外区 ID，2.99 美元）
- **摄影**
  - Project Indigo:拍摄高倍率画面时会合成更高分辨率的照片，细节更多、噪声更少（需要外区 ID）
  - blackmagic cam：可以提供更多画质选项，可以套 lut 实时预览（需要外区 ID）
...
- AE 盗版插件：[lookae](https://www.lookae.com/)
- 服务器 ip 优选网站：[wetest](https://www.wetest.vip/)
...
- Aescripts Rift：层管理脚本
- Deep Glow：提供辉光效果
- trapcodeparticular：粒子插件
- GoodbyeGreenscreen：视频背景智能抠像
- EVisionFX REFlex：扭曲变形变脸操作
- Pastiche：图片汇聚成自定义图层
