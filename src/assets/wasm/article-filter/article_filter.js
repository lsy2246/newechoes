...
export class ArticleFilterJS {
    ...
    static init(index_data) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            const ptr0 = passArray8ToWasm0(index_data, wasm.__wbindgen_export);
            const len0 = WASM_VECTOR_LEN;
...
if (Symbol.dispose) ArticleFilterJS.prototype[Symbol.dispose] = ArticleFilterJS.prototype.free;
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./article_filter_bg.js": import0,
    };
}

const ArticleFilterJSFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_articlefilterjs_free(ptr, 1));
